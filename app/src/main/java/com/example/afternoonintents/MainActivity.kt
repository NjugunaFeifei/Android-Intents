...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnSms.setOnClickListener {
            val uri: Uri = Uri.parse("smsto:0712057650")
            val intent = Intent(Intent.ACTION_SENDTO, uri)
            intent.putExtra("sms_body", "The SMS text")
            startActivity(intent)
        }
        btnEmail.setOnClickListener {
            val emailIntent =Intent(Intent.ACTION_SENDTO, Uri.fromParts("mailto", "njugunafeifei@gmail.com", null))
        ...
        btnShare.setOnClickListener {
            ...
            shareIntent.putExtra(Intent.EXTRA_TEXT, "Hey, download this app from playstore!")
